...
<body>
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		...
		<div class="navbar-collapse collaspse">
			<ul class="nav navbar-nav" id="hov">
				<li>
					<a href="?menu=lapmenu"><div class="glyphicon glyphicon-tasks"></div>&nbsp;&nbsp;LAPORAN MENU</a>
				</li>
			</ul>
			<ul class="nav navbar-nav" id="hov">
				<li>
					<a href="?menu=laptransaksi"><div class="glyphicon glyphicon-glass"></div>&nbsp;&nbsp;LAPORAN TRANSAKSI</a>
				</li>
			</ul>
			<ul class="nav navbar-nav" id="hov">
				<li>
	...
	<?php  
		switch (@$_GET['menu']){
			case 'laptransaksi':include 'laporan_transaksi.php'; break;	
			case 'lapmenu':include 'laporan_menu.php'; break;	
